...
LEGACY_REPO = "soia-open-skills"
LEGACY_SKILL_TYPE = "cwork"
...
def config_candidates() -> list[Path]:
    ...
    root = Path("~/.config/soia-skills").expanduser()
    candidates.append(root / SKILL_NAME / "config.yml")
    candidates.append(
        root / LEGACY_REPO / LEGACY_SKILL_TYPE / SKILL_NAME / "config.yml"
    )
    return candidates
