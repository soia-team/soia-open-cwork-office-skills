...
`soia-open-cwork-office-skills` and `soia-private-skills` intentionally use the same template
...
- `hard` / `optional` list SOIA-managed skill names only (published from
  soia-open-cwork-office-skills or soia-private-skills).
...
~/.config/soia-skills/soia-open-cwork-office-skills/soia-pkm/soia-pkm-transform/config.yml
```
...
`~/.config/soia-skills/soia-open-cwork-office-skills/soia-pkm/soia-pkm-transform/notebooklm`.
...
format and is intentionally absent from `soia-open-cwork-office-skills`.
