...
def resolve_repo_name(root: Path) -> str:
    ...
    # https://github.com/soia-team/soia-open-cwork-office-skills.git  -> soia-open-cwork-office-skills
    # git@github.com:soia-team/soia-open-cwork-office-skills.git       -> soia-open-cwork-office-skills
    tail = url.rstrip("/")
    for sep in ("/", ":"):
        if sep in tail:
